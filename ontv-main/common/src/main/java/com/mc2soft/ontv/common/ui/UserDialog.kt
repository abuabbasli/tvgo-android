...
import com.mc2soft.ontv.common.databinding.UserDlgBinding

open class UserDialog : BaseDialog() {
    private lateinit var vb: UserDlgBinding
        private set


    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View {
        vb = UserDlgBinding.inflate(inflater, container, false)
    ...
    fun setStyleError() {
        vb.icon.setImageResource(R.drawable.baseline_error_outline_224)
    }
